 ...
 *
 * @details
 * host_slave_send 专题：模拟 UART 双向字节流。
 ...
 * 2026-07-31 linzhiwei 引入 host_slave_send 专题复用      v1.0.1
 * 2026-07-30 linzhiwei 首次发布                            v1.0.0
 */
#ifndef HOST_SLAVE_SEND_LINK_Q_H
#define HOST_SLAVE_SEND_LINK_Q_H
...
#endif /* HOST_SLAVE_SEND_LINK_Q_H */
